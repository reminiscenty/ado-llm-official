...
def normalize_fvals(f_vals: dict, ckt: dict, check_specs=False):
    ...
    f_vals['gbw_normed'] = min(2, f_vals['gbw_normed'])
    f_vals['gain_normed'] =  min(2, f_vals['gain_normed'])
    f_vals['cmrr_normed'] = min(2, f_vals['cmrr_normed'])
    f_vals['pm_normed'] = min(2, f_vals['pm_normed'])
